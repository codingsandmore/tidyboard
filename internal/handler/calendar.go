...
func (h *CalendarHandler) List(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		respond.Error(w, r, http.StatusInternalServerError, "internal_error", "failed to list calendars")
		return
	}
...
func (h *CalendarHandler) AddICal(w http.ResponseWriter, r *http.Request) {
	...
	if req.Name == "" || req.URL == "" {
		respond.Error(w, r, http.StatusBadRequest, "validation_error", "name and url are required")
		return
	}
	...
	if err != nil {
		respond.Error(w, r, http.StatusInternalServerError, "internal_error", "failed to create calendar")
		return
	}
...
func (h *CalendarHandler) SyncICal(w http.ResponseWriter, r *http.Request) {
	...
	if cal.Source != "ical_url" {
		respond.Error(w, r, http.StatusBadRequest, "bad_request", "calendar is not an iCal URL calendar")
		return
	}
